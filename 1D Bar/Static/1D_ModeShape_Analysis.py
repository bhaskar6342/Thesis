...
for i in range(5):
    ...
    plt.plot(x_nodes, mode_shape, label=f"Mode {i+1} ({natural_frequencies[i]:.2f} Hz)")
...
plt.legend()
plt.tight_layout()
plt.savefig(r'C:\Users\USER\OneDrive - IIT Hyderabad\Mtech Aerospace Engineering\Semester 3\Project Thesis\Results\ModeShapes.jpeg', format='jpeg', dpi=600)
plt.show()
